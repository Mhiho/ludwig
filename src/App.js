  ...
  render(){
    return (
      <HashRouter>
        ...
        <PrivateRoute  path='/myBooks/:id/addBookCover' component={AddBookCover} />
        <PrivateRoute  path='/myBooks/:id/writing' component={Writing} />
        <PrivateRoute  path='/myBooks/:id/chapters/:chapterNr' component={NewChapter} />
        <PrivateRoute  path='/:id/reading/:chapterNr' component={Reading} />
